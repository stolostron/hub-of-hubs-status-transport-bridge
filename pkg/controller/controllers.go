...
import (
	...
	configCtrl "github.com/stolostron/hub-of-hubs-status-transport-bridge/pkg/controller/config"
	"github.com/stolostron/hub-of-hubs-status-transport-bridge/pkg/controller/dispatcher"
	workerpool "github.com/stolostron/hub-of-hubs-status-transport-bridge/pkg/db/worker-pool"
	"github.com/stolostron/hub-of-hubs-status-transport-bridge/pkg/dbsyncer"
...
func Setup(mgr ctrl.Manager, dbWorkerPool *workerpool.DBWorkerPool, conflationManager *conflator.ConflationManager,
	...
	dbSyncers := []dbsyncer.DBSyncer{
		...
		dbsyncer.NewSubscriptionsDBSyncer(ctrl.Log.WithName("subscriptions-db-syncer")),
